...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager - Akhil Shende")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#7FFFD4")  
    functions_frame = tk.Frame(guiWindow, bg = "#7FFFD4")  
    listbox_frame = tk.Frame(guiWindow, bg = "#7FFFD4")  
